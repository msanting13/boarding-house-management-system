...
<div class="card card-outline card-primary">
    <div class="card-header text-center">
        <a href="#" class="h3">Create New Password</a>
    </div>
    <div class="card-body">
      ...
      <form action="{{ route('admin.password.request') }}" method="post">
        ...
        <div class="form-group mb-3">
            <div class="input-group">
                <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email }}" placeholder="Email">
