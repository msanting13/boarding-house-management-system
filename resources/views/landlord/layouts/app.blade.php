...
<head>
    ...
    <title>@yield('page-title') | Boarding House Management System</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        <!-- Navbar -->
        @include('landlord.layouts.includes.main-header')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        @include('landlord.layouts.includes.main-sidebar')
        ...
        <!-- Main Footer -->
        @include('landlord.layouts.includes.footer')
    </div>
<!-- ./wrapper -->
